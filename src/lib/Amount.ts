 ...
 */
export const createAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
 ...
 * @category Utils — Amounts
 */
export const createAmountFromDecimals = <I extends AmountIdentifier, D extends AmountDecimals>(
 ...
 * @category Utils — Amounts
 */
export const percentAmount = <D extends AmountDecimals>(percent: number, decimals: D = 2 as D): Amount<'%', D> =>
  createAmountFromDecimals(percent, '%', decimals)

/**
 * Creates an amount of SPL tokens from the provided decimal value.
 * @category Utils — Amounts
 */
export const tokenAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
  tokens: number,
  identifier?: I,
  decimals?: D,
): Amount<I, D> => createAmountFromDecimals(tokens, (identifier ?? 'splToken') as I, (decimals ?? 0) as D)

/**
 * Creates a {@link SolAmount} from the provided lamports.
 * @category Utils — Amounts
 */
export const lamports = (lamports: BigIntInput): SolAmount => createAmount(lamports, 'SOL', 9)

/**
 * Creates a {@link SolAmount} from the provided decimal value in SOL.
 * @category Utils — Amounts
 */
export const sol = (sol: number): SolAmount => createAmountFromDecimals(sol, 'SOL', 9)

/**
 * Creates a {@link UsdAmount} from the provided decimal value in USD.
 * @category Utils — Amounts
 */
export const usd = (usd: number): UsdAmount => createAmountFromDecimals(usd, 'USD', 2)
 ...
 * @category Utils — Amounts
 */
export function assertAmount<I extends AmountIdentifier, D extends AmountDecimals>(
  amount: Amount,
  identifier: I,
  decimals: D,
): asserts amount is Amount<I, D> {
 ...
 * @category Utils — Amounts
 */
export function assertSameAmounts(left: Amount, right: Amount, operation?: string) {
 ...
 * @category Utils — Amounts
 */
export const addAmounts = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
  right: Amount<I, D>,
): Amount<I, D> => {
 ...
 * @category Utils — Amounts
 */
export const subtractAmounts = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
  right: Amount<I, D>,
): Amount<I, D> => {
 ...
 * @category Utils — Amounts
 */
export const multiplyAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
 ...
 * @category Utils — Amounts
 */
export const divideAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
 ...
 * @category Utils — Amounts
 */
export const absoluteAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
  value: Amount<I, D>,
): Amount<I, D> => {
 ...
 * @category Utils — Amounts
 */
export const compareAmounts = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
  right: Amount<I, D>,
): -1 | 0 | 1 => {
 ...
 * @category Utils — Amounts
 */
export const isEqualToAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
  right: Amount<I, D>,
 ...
 * @category Utils — Amounts
 */
export const isLessThanAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
  right: Amount<I, D>,
 ...
 * @category Utils — Amounts
 */
export const isLessThanOrEqualToAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
  right: Amount<I, D>,
): boolean => compareAmounts(left, right) <= 0
 ...
 * @category Utils — Amounts
 */
export const isGreaterThanAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
  right: Amount<I, D>,
): boolean => compareAmounts(left, right) > 0
 ...
 * @category Utils — Amounts
 */
export const isGreaterThanOrEqualToAmount = <I extends AmountIdentifier, D extends AmountDecimals>(
  left: Amount<I, D>,
  right: Amount<I, D>,
): boolean => compareAmounts(left, right) >= 0
 ...
 * @category Utils — Amounts
 */
export const isZeroAmount = (value: Amount): boolean => value.basisPoints === BigInt(0)

/**
 * Whether the amount is positive.
 * @category Utils — Amounts
 */
export const isPositiveAmount = (value: Amount): boolean => value.basisPoints >= BigInt(0)

/**
 * Whether the amount is negative.
 * @category Utils — Amounts
 */
export const isNegativeAmount = (value: Amount): boolean => value.basisPoints < BigInt(0)
